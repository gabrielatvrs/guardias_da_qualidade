...
public class CasoDeTeste1 extends Configuracao {
    ...
    public void clico_no_botao_confirmar() {
        WebElement botao = Configuracao.browser.findElement(By.cssSelector("#onetrust-pc-sdk > div.ot-button-group-parent > div.ot-button-group > button.save-preference-btn-handler.onetrust-close-btn-handler"));
        botao.click();
        fechar();
    }
}